...
const Data = () => {
  ...
  const titles = ["Android Developer", "UI/UX Designer"];
  ...
  return (
    <div className="home__data">
      ...
      {/* <h3 className="typing-animation">I am a {isTyping ? jobTitle : titles[titleIndex]}</h3> */}
...
//         <h1 className="home__title">  Sreeginy   
...
//         <p className="home__description">I'm creative Designer based in Sri Lanka, and I'm very passionate and dedicated to my work.</p>
