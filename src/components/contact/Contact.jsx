                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:sreeginy@gmail.com.com" className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                        ...
                        <i className="bx bxl-whatsapp contact__card-icon"></i>
                            ...
                            <span className="contact__card-data">0772901267</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">user-abn</span>
