...
const Qualification = () => {
    ...
    return (
        ...
        <section className="qualification section" id="qualification">
            ...
            <span className="section__subtitle">My education has been a journey of self-discovery and growth.  <br className="break-mobile" />
             My educational & work experience are as follows.</span>
