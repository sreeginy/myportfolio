...
const Data = () => {
  ...
  // Change job title every 5 seconds
  useEffect(() => {
    ...
    <div className="home__data">
      ...
      <h2 className="typing-animation">
        ...
        <span className="highlight">
          {isTyping ? jobTitle : titles[titleIndex]}
        </span>
      </h2>

      <p className="home__description">
        I'm a creative designer based in Sri Lanka,{" "}
        <br className="break-mobile" /> deeply passionate & dedicated to my
        work.
      </p>
